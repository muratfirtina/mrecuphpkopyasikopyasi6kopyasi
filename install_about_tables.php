...
echo "<h1 class='text-center mb-4'><i class='fas fa-database me-2'></i>About Sayfası Database Kurulumu</h1>";
...
try {
    ...
    echo "<p><i class='fas fa-check text-success me-2'></i>about_content tablosu hazır</p>";
    ...
    echo "<p><i class='fas fa-check text-success me-2'></i>about_core_values tablosu hazır</p>";
    ...
    echo "<p><i class='fas fa-check text-success me-2'></i>about_service_features tablosu hazır</p>";
    ...
    echo "<p><i class='fas fa-check text-success me-2'></i>about_vision tablosu hazır</p>";
    ...
    if ($stmt->fetchColumn() == 0) {
        ...
        $stmt->execute([
            ...
            '[{"title":"Anında Erişim","icon":"fas fa-check-circle text-success"},{"title":"Global Hizmet","icon":"fas fa-check-circle text-success"},{"title":"Yenilikçi Vizyon","icon":"fas fa-check-circle text-success"},{"title":"10+ Yıl Deneyim","icon":"fas fa-check-circle text-success"}]'
        ]);
        echo "<p><i class='fas fa-plus text-success me-2'></i>Ana içerik örnek verisi eklendi</p>";
    } else {
        echo "<p><i class='fas fa-info text-warning me-2'></i>Ana içerik zaten mevcut</p>";
    }
    ...
    if ($stmt->fetchColumn() == 0) {
        $core_values_data = [
            ['Müşteri Memnuniyeti Odaklı', 'Müşteri memnuniyeti bizim için en önemli öncelik. Açık ve kesintisiz iletişim ilkemizle, müşterilerimizin her türlü sorusuna yanıt vermeye hazırız.', 'fas fa-heart', 'text-primary', 'bg-primary bg-opacity-10', 1],
            ['Güvenilir ve Çözüm Odaklı Yaklaşım', 'Sektördeki en güncel ve güvenilir teknolojileri kullanıyoruz. Çözüm odaklı yaklaşımımız sayesinde iş ortaklarımıza daima destek oluyoruz.', 'fas fa-shield-alt', 'text-success', 'bg-success bg-opacity-10', 2]
        ];
        ...
        echo "<p><i class='fas fa-plus text-success me-2'></i>Temel değerler örnek verileri eklendi (2 kayıt)</p>";
    } else {
        echo "<p><i class='fas fa-info text-warning me-2'></i>Temel değerler zaten mevcut</p>";
    }
    ...
    if ($stmt->fetchColumn() == 0) {
        $features_data = [
            ['Profesyonel Hizmet Anlayışı', 'Müşteri memnuniyetini ön planda tutan profesyonel hizmet anlayışımız ile sektörde fark yaratıyoruz.', 'https://storage.acerapps.io/app-1580/professional-development.png', 'fas fa-user-tie', 1],
            ['Güçlü ve Güvenilir Yazılım', 'Araç performansını optimize eden güvenilir yazılım çözümleri ile en iyi sonuçları elde edin.', 'https://storage.acerapps.io/app-1580/convenience.png', 'fas fa-laptop-code', 2],
            ['Sektördeki Deneyim ve Uzmanlık', 'Sektörde 10 yıllık deneyim ve uzmanlık ile size en kaliteli hizmeti sunuyoruz.', 'https://storage.acerapps.io/app-1580/professional.png', 'fas fa-medal', 3],
            ['Teknik Destek', 'Her adımda yanınızda olan kapsamlı teknik destek hizmeti ile sorunlarınıza anında çözüm.', 'https://storage.acerapps.io/app-1580/development.png', 'fas fa-headset', 4]
        ];
        ...
        echo "<p><i class='fas fa-plus text-success me-2'></i>Hizmet özellikleri örnek verileri eklendi (4 kayıt)</p>";
    } else {
        echo "<p><i class='fas fa-info text-warning me-2'></i>Hizmet özellikleri zaten mevcut</p>";
    }
    ...
    if ($stmt->fetchColumn() == 0) {
        ...
        $stmt->execute([
            ...
            '[{"title":"Sürekli İnovasyon","description":"Teknolojik gelişmeleri yakından takip ediyoruz","icon":"fas fa-rocket text-primary"},{"title":"Global Perspektif","description":"Dünya çapında hizmet sunma hedefi","icon":"fas fa-globe text-primary"}]'
        ]);
        echo "<p><i class='fas fa-plus text-success me-2'></i>Vizyon örnek verisi eklendi</p>";
    } else {
        echo "<p><i class='fas fa-info text-warning me-2'></i>Vizyon içeriği zaten mevcut</p>";
    }
...
if ($steps_completed === $total_steps) {
    ...
    echo "<hr class='my-4'>";
    echo "<h4><i class='fas fa-rocket me-2'></i>Yeni Özellikler</h4>";
    echo "<div class='row text-center'>";
    echo "<div class='col-md-3'><i class='fas fa-cloud-upload fa-2x text-primary mb-2'></i><br><strong>Resim Upload</strong><br><small>Drag & Drop Desteği</small></div>";
    echo "<div class='col-md-3'><i class='fas fa-eye fa-2x text-success mb-2'></i><br><strong>Canlı Önizleme</strong><br><small>Anında Görüntüleme</small></div>";
    echo "<div class='col-md-3'><i class='fas fa-mobile-alt fa-2x text-info mb-2'></i><br><strong>Responsive</strong><br><small>Mobile Uyumlu</small></div>";
    echo "<div class='col-md-3'><i class='fas fa-shield-alt fa-2x text-warning mb-2'></i><br><strong>Güvenli</strong><br><small>Dosya Doğrulama</small></div>";
    echo "</div>";
    echo "</div>";
