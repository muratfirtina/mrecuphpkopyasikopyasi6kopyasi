 ...
 * Ters kredi sistemi ve gelişmiş bildirim sistemi ile birleştirilmiş versiyon
 */
...
})(window,document,'script','dataLayer','GTM-K896QT2K');</script>
<!-- End Google Tag Manager -->
    ...
    <meta name="theme-color" content="#011b8f">
    ...
    <style>
        /* Global Styles */
        :root {
            --primary-gradient: linear-gradient(135deg, #011b8f 0%, #ab0000 100%);
        ...
        * {
        ...
        .form-select:focus {
            border-color: #011b8f;
            box-shadow: 0 0 0 0.2rem rgba(1, 27, 143, 0.25);
        }
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-55J9Z442T3"></script>
    <script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K896QT2K"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <style>
        ...
        .dropdown-menu {
            ...
            /* Bootstrap varsayılan display:none'ı ezeriz */
        }
