...
<!-- End Google Tag Manager -->
    ...
    <script type="application/ld+json">
        {
            ...
            "image": "<?php echo BASE_URL; ?>/favicon.ico",
            "priceRange": "$",
            "sameAs": [
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="<?php echo BASE_URL; ?>/favicon.ico">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu modern-dropdown dropdown-menu-start" aria-labelledby="productsDropdown">
                            <li>
                                <h6 class="dropdown-header">KATEGORİLER</h6>
                            </li>
                            <?php
                            // Kategorileri getir
                            try {
