<?php
/**
 * Admin ve User file-detail.php dosyalarına ek dosya bölümlerini ekleyen script
 */
...
// Admin file-detail.php güncelleme
$adminFile = $basePath . 'admin/file-detail.php';
$adminContent = file_get_contents($adminFile);

// Admin için ek dosya bölümü HTML'i
$adminAdditionalFilesSection = <<<'EOD'
...
// Admin dosyasına ekle
if (strpos($adminContent, '<!-- Ek Dosyalar Bölümü -->') === false) {
    // Chat Penceresi'nden önce ekle
    $adminContent = str_replace('<!-- Chat Penceresi -->', $adminAdditionalFilesSection . "\n<!-- Chat Penceresi -->", $adminContent);
    file_put_contents($adminFile, $adminContent);
    echo "✓ Admin file-detail.php güncellendi.\n";
} else {
    echo "! Admin file-detail.php zaten güncel.\n";
}

// User file-detail.php güncelleme
$userFile = $basePath . 'user/file-detail.php';
$userContent = file_get_contents($userFile);

// User için ek dosya bölümü - biraz farklı
$userAdditionalFilesSection = <<<'EOD'
...
// User dosyasına ekle
if (strpos($userContent, '<!-- Ek Dosyalar Bölümü -->') === false) {
    // Chat Penceresi'nden önce ekle
    $userContent = str_replace('<!-- Chat Penceresi -->', $userAdditionalFilesSection . "\n<!-- Chat Penceresi -->", $userContent);
    file_put_contents($userFile, $userContent);
    echo "✓ User file-detail.php güncellendi.\n";
} else {
    echo "! User file-detail.php zaten güncel.\n";
}

echo "\n=== GÜNCELLEME TAMAMLANDI ===\n";
echo "Ek dosya gönderme sistemi başarıyla eklendi.\n\n";
echo "Yapılan işlemler:\n";
echo "1. Admin file-detail.php'ye ek dosya bölümü eklendi\n";
echo "2. User file-detail.php'ye ek dosya bölümü eklendi\n";
echo "3. ajax/additional_files.php AJAX handler oluşturuldu\n";
echo "4. download-additional.php indirme dosyası mevcut\n";
echo "5. FileManager.php'de gerekli fonksiyonlar mevcut\n\n";
