    ...
    <div class="col-12">
        <div class="design-card">
            <div class="design-card-header">
                <h5 class="mb-0">
                    <i class="fas fa-chart-line me-2"></i>Design Panel Dashboard
                </h5>
            </div>
            <div class="card-body">
...
<div class="row g-4 mb-4">
        ...
        <div class="design-card h-100">
            <div class="card-body text-center p-4">
                ...
                <a href="sliders.php" class="btn btn-design-primary">
                    <i class="fas fa-arrow-right me-2"></i>Slider Yönet
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="design-card h-100">
            <div class="card-body text-center p-4">
                <div class="mb-3">
                    <i class="fas fa-palette text-success" style="font-size: 3rem;"></i>
                </div>
                ...
                <a href="settings.php" class="btn btn-outline-success">
                    <i class="fas fa-arrow-right me-2"></i>Ayarlar
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="design-card h-100">
            <div class="card-body text-center p-4">
                <div class="mb-3">
                    <i class="fas fa-edit text-info" style="font-size: 3rem;"></i>
                </div>
                ...
                <a href="content.php" class="btn btn-outline-info">
                    <i class="fas fa-arrow-right me-2"></i>İçerik Düzenle
                </a>
            </div>
        </div>
    </div>
...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="design-card">
            <div class="design-card-header">
                <h5 class="mb-0">
                    <i class="fas fa-clock me-2"></i>Son Güncellemeler
                </h5>
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="../index.php" target="_blank" class="btn btn-outline-success">
                        <i class="fas fa-eye me-2"></i>Site Önizleme
                    </a>
                    <a href="content.php" class="btn btn-outline-info">
